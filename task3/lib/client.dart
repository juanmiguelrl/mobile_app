...
class Client {
  static final timeout = 30;  // in seconds

  static Future<Response> fetchResult(File file) async {

    final response = await http.post(
      'https://api.imagga.com/v2/tags',
      headers: {HttpHeaders.authorizationHeader: 'Basic YWNjXzllM2RkOTg3ZjQ1Mzk2ZjoxZTcwMzc5NzMzZDkzOWY1NGJjNGM1MGJmZmQ3MTMwMg=='},
      body: {"image_base64": base64Encode(file.readAsBytesSync())},
    ).timeout(
      Duration(seconds: timeout),
      onTimeout: () => throw TimeoutException("Timeout expired"),
    );
