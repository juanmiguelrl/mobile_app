...
class RequestProvider with ChangeNotifier {
  ...
  void fetchResult(File file) async {
    try {
      ...
      _updateStatus(RequestStatus.ERROR, 'Timeout expired', 'Check your internet coverage and try again');
    } on SocketException catch (e) {
      _updateStatus(RequestStatus.ERROR, 'Socket exception', 'Cannot establish a connection with the server');
